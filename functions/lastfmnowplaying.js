    ...
    try {
      ...
      const svg = `
        <svg xmlns="http://www.w3.org/2000/svg" width="${customWidth}" height="${height}" viewBox="0 0 ${customWidth} ${height}">
          ...
          <!-- Content (Right Side) -->
          <g transform="translate(${artSize + contentPadding}, ${contentPadding * 1.5})">
            <!-- Last.fm Logo and Status -->
            <g transform="translate(0, ${titleSize * 0.8})">
              <path transform="translate(0, -${titleSize * 0.25}) scale(${logoSize/22})" 
                    fill="#D6D5C9" 
              ...
              <text x="${logoSize * 1.4}" y="${titleSize * 0.1}" class="title">
