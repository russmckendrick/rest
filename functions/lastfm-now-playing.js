  ...
  try {
    ...
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${customWidth}" height="${height}" viewBox="0 0 ${customWidth} ${height}">
        ...
        <!-- Header Group -->
        <g transform="translate(${artSize + contentPadding * 1.5}, ${contentPadding * 2})">
          <!-- Last.fm Logo and Text Group -->
          <g transform="translate(0, ${fontSize * 1.2})">
            <path transform="translate(0, -${logoSize/3}) scale(${logoSize/25})" 
                  fill="#D6D5C9" 
            ...
            <!-- Header Text -->
            <text x="${logoSize * 1.5}" y="-${logoSize/3}" class="header-text" dominant-baseline="central">Last Played</text>
          </g>
        </g>
