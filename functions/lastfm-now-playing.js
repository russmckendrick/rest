    ...
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${customWidth}" height="${height}" viewBox="0 0 ${customWidth} ${height}">
        ...
        <g transform="translate(${artSize + contentPadding * 1.5}, ${contentPadding * 1.5})">
          <!-- Last.fm Logo -->
          <path transform="translate(0, ${fontSize * 0.2}) scale(${logoSize/25})" 
                fill="#D6D5C9" 
          ...
          <!-- Header Text -->
          <text x="${logoSize * 1.5}" y="${fontSize * 0.2}" class="header-text" dominant-baseline="central">Last Played</text>
        </g>
